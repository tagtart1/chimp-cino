...
const BlackjackActions = ({
  ...
  const doubleEndpoint =
    "https://api.chimpcino.com/api/v1/blackjack/games/double";
  const splitEndpoint =
    "https://api.chimpcino.com/api/v1/blackjack/games/split";
  const insuranceEndpoint =
    "https://api.chimpcino.com/api/v1/blackjack/games/insurance";
